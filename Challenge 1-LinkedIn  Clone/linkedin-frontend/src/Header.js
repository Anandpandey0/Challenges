    ...
    <>
      <div className="header">
        ...
        <div className="header-right">
          ...
          <HeaderOption
            title="Me"
            avatar="https://media.licdn.com/dms/image/C5603AQFupeFv2-DKNQ/profile-displayphoto-shrink_100_100/0/1596870504882?e=1678924800&v=beta&t=HC3MbpEEeV_LzOHk_9PeEZAAH5Pz0x9PBpgPHPfM7UE"
          />
        </div>
      </div>
    </>
